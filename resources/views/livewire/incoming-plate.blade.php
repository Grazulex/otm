                                ...
                                <div class="grid-cols-1      filament-forms-radio-component flex flex-wrap gap-3">
                                    <div class="flex items-start gap-2">
                                        <div class="flex items-center h-5">
                                            <input wire:model="type" name="type" id="type-cod" type="radio" value="cod" wire:model.defer="type" class="focus:ring-primary-500 h-4 w-4 text-primary-600 disabled:opacity-70 dark:bg-gray-700 dark:checked:bg-primary-500 border-gray-300 dark:border-gray-500">
                                        </div>
                                        <div class="text-sm">
                                    ...
                                    <div class="flex items-start gap-2">
                                        <div class="flex items-center h-5">
                                            <input wire:model="type" name="type" id="type-non-cod" type="radio" value="non-cod" wire:model.defer="type" class="focus:ring-primary-500 h-4 w-4 text-primary-600 disabled:opacity-70 dark:bg-gray-700 dark:checked:bg-primary-500 border-gray-300 dark:border-gray-500">
                                        </div>
                                        <div class="text-sm">
                                    ...
                                    <div class="flex items-start gap-2">
                                        <div class="flex items-center h-5">
                                            <input wire:model="type" name="type" id="type-rush" type="radio" value="rush" wire:model.defer="type" class="focus:ring-primary-500 h-4 w-4 text-primary-600 disabled:opacity-70 dark:bg-gray-700 dark:checked:bg-primary-500 border-gray-300 dark:border-gray-500">
                                        </div>
                                        <div class="text-sm">
